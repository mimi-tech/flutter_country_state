...
class Country1 {
  static List<String> country1 = <String>[
    ...
    "Bhutan", "Bolivia", "Bosnia", "Botswana", "Bouvet Island", "Brazil",
...
class Country3{
  static List<String> country3 = <String>[
    ...
    "Iran", "Iraq", "Ireland", "Isle of Man", "Israel", "Italy", "Jamaica", "Japan", "Jordan",
...
class Country4{
  static List<String> country4 = <String>[
    ...
    "Mayotte", "Mexico", "Micronesia", "Miquelon", "Moldova",
